...
const int COUNTER = 0; //カウンターの初期値

const float COLLISION = 20.0; //TODO: 当たり判定の幅(とりあえず)

const int PLAYER_HP = 12; //体力(内訳３＊４)

const int PLAYER_POWER = 1; //プレイヤーの攻撃力の基準値

const float PLAYER_SPEED = 5.0; //プレイヤーの移動速度

const int ENEMY_POWER = 3; //敵の攻撃力の基準値

const int FIRE_RATE = 120; //発射レートの基準値

const int BULLET_POWER = 1; //弾自体の攻撃力の
